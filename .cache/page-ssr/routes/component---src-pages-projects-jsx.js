...
var Layout = __webpack_require__(4746);
// EXTERNAL MODULE: ./src/components/SEO.jsx
var SEO = __webpack_require__(2816);
;// ./src/components/ImpactCard.jsx
const ImpactCard=({title,role,timeframe,bullets})=>/*#__PURE__*/index_js_default().createElement("div",{className:"rounded-2xl border p-6 shadow-sm hover:shadow-md transition"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex items-baseline justify-between"},/*#__PURE__*/index_js_default().createElement("h3",{className:"text-lg font-semibold"},title),/*#__PURE__*/index_js_default().createElement("span",{className:"text-xs text-gray-500"},timeframe)),/*#__PURE__*/index_js_default().createElement("p",{className:"text-sm mt-1 text-gray-600"},"Role: ",role),/*#__PURE__*/index_js_default().createElement("ul",{className:"list-disc pl-5 mt-3 space-y-1 text-sm"},bullets.map((b,i)=>/*#__PURE__*/index_js_default().createElement("li",{key:i},b))));/* harmony default export */ const components_ImpactCard = (ImpactCard);
...
function Projects(){return/*#__PURE__*/index_js_default().createElement(Layout/* default */.A,null,/*#__PURE__*/index_js_default().createElement(SEO/* default */.A,{title:"Projects"}),/*#__PURE__*/index_js_default().createElement("section",{className:"max-w-6xl mx-auto px-6 pt-16 pb-16"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-3xl font-bold"},"Projects & Case Studies"),/*#__PURE__*/index_js_default().createElement("p",{className:"text-gray-600 mt-2"},"Problem \u2192 Role \u2192 Architecture \u2192 Business Impact."),/*#__PURE__*/index_js_default().createElement("div",{className:"mt-8 grid grid-cols-1 md:grid-cols-2 gap-6"},featured.map((p,i)=>/*#__PURE__*/index_js_default().createElement(components_ImpactCard,Object.assign({key:i},p))))));}
